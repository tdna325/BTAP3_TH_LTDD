...
public class HoaDonGroupAdater extends BaseExpandableListAdapter {
    ...
    public long getChildId(int groupPosition, int childPosition) {
        ...
        return product.getId_product_355();
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView size_sp_355 = convertView.findViewById(R.id.size_giohang_355);
        ...
        EditText ghichu = convertView.findViewById(R.id.ghichu_giohang_355);
        ghichu.setVisibility(View.GONE);

        name_sp_355.setText(product.getName_product_355());
        size_sp_355.setText(product.getSize());
        gia_sp_355.setText(product.getThanhTien() +".000 đ");
        soluong_355.setText(product.getSoluong()+"");
        notifyDataSetChanged();
        return convertView;
    }
